...
namespace Covergo.AADProvisioning.Service
{
    public abstract class ProviderAdapterTemplate<T> : IProviderAdapter<T> where T : Resource
    {
        ...
        public virtual async Task<Protocal.QueryResponseBase> Query(
            ...
            string correlationIdentifier)
        {
            ...
            Protocal.QueryResponseBase result = await this.Provider.PaginateQueryAsync(queryRequest).ConfigureAwait(false);
